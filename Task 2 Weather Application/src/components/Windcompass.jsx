...
export default function Compass({ speed, direction }) {
  // Ensure the speed and direction values are properly handled
  const [rotation, setRotation] = useState(0);

  useEffect(() => {
    // Set the compass pointer's rotation based on the wind direction
    setRotation(direction);
  }, [direction]);

  return (
    <div className="md:h-[186px] md:w-full  xl:h-[186px] xl:w-[250px] w-full h-[46vw] border rounded-2xl md:p-6 p-4 dark:text-[#A3A3A3] dark:bg-[#0A0A0A] bg-[#F4F4F5] dark:border-[#262626]">
         <div className='flex items-center'>
        <Wind className='mr-2' size={16}/>
        <h1>Wind</h1>
        </div>
        <div className="flex justify-center items-center pt-4 md:pt-2">
      <div className="relative -mt-5 flex h-[35vw] w-[35vw] items-center justify-center md:-mt-5 md:h-[9rem] md:w-[9rem]">
        {/* Wind speed display */}
